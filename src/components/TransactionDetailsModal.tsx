...
const TransactionDetailsModal: React.FC<TransactionDetailsModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 z-50 animate-fadeIn">
            <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 w-full max-w-sm sm:max-w-3xl lg:max-w-5xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto shadow-2xl animate-slideInUp">
                <div className="flex items-center justify-between mb-4 sm:mb-6 lg:mb-8">
                    <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Transaction Details</h2>
                ...
                {transaction ? (
                    <div className="space-y-4 sm:space-y-6">
                        {/* Transaction Header */}
                        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-6">
                            <div className="flex items-start sm:items-center gap-3 sm:gap-4 mb-2 sm:mb-4">
                                ...
                                <div className="min-w-0 flex-1">
                                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 break-all">{transaction.transaction_id}</h3>
                                    <p className="text-gray-600 text-base sm:text-lg font-semibold">{transaction.amount} {transaction.currency}</p>
                                    ...
                                    <div className="space-y-4 sm:space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                                                rows={3}
