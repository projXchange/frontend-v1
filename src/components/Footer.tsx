      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 sm:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/submit-project" className="text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-200 transition-colors">Submit Project Enquiry</Link></li>
        ...
        <div className="mt-6 pt-6 border-t border-gray-800 dark:border-slate-900">
          <p className="text-xs text-gray-500 dark:text-gray-600 text-center">
            Note: Hero banner videos and carousel images are AI-generated for promotional purposes.
          </p>
        </div>
      </div>
    </footer>
