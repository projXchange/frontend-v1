                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center">
                      ...
                      <span className="ml-1 text-sm font-semibold text-gray-800 dark:text-gray-200">4.8</span>
                      <span className="ml-1 text-sm text-gray-500 dark:text-gray-400">({item.project.purchase_count || 0})</span>
                    </div>
                  </div>

                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition">
                    {item.project.title}
                  </h3>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    {item.project?.pricing ? (
                      <div className="flex items-center space-x-2">
                        <span className="text-lg font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100">
                      ...
                      <div className="text-gray-500 dark:text-gray-400 text-sm">Price not available</div>
                    )}

                    <div className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-400">
                  ...
                  <div className="flex gap-3">
                    ...
                    <Link
                      ...
                      className="px-4 py-3 border border-gray-300 rounded-xl text-gray-700 dark:text-gray-300 hover:bg-gray-50 hover:scale-105 transition-all duration-200 flex items-center justify-center"
                    >
