        ...
        {cart.length === 0 ? (
          ...
          <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">{item.project.title}</h3>
                          <p className="text-gray-600 dark:text-gray-300 text-sm mb-3 line-clamp-2">{item.project.description}</p>

                          <div className="flex flex-wrap gap-2 mb-3">
                            {item.project.tech_stack?.slice(0, 3).map((tech, i) => (
                              <span key={i} className="flex items-center gap-1 px-2 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded-full text-xs font-medium">
                                <Tag className="w-3 h-3" /> {tech}
                              </span>
                            ))}
                          </div>

                          <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-300 dark:text-gray-400">
                        ...
                        <div className="flex flex-col items-end gap-3">
                          <div className="text-right">
                            <div className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100">₹{item.project.pricing?.sale_price}</div>
                          ...
                          <div className="flex gap-2">
                            <Link
                              ...
                              className="px-3 py-2 border border-gray-300 dark:border-slate-600 placeholder-gray-400 dark:placeholder-gray-500 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700 hover:scale-105 transition-all duration-200 flex items-center gap-1"
                            >
            ...
            <div className="lg:col-span-1">
              <div className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-gray-100 dark:border-slate-700 sticky top-8">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="border-t border-gray-200 dark:border-slate-700 pt-4">
                    <div className="flex justify-between text-lg font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100">
                      <span>Total</span>
                ...
                <div className="space-y-3">
                  ...
                  <button
                    onClick={clearCart}
                    className="w-full border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 py-3 rounded-xl font-semibold hover:bg-gray-50 dark:hover:bg-slate-700 hover:scale-105 transition-all duration-200"
                  >
                    Clear Cart
                  </button>
                </div>
                ...
                <div className="mt-6 space-y-4">
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-800/30">
                    <h4 className="font-semibold text-blue-900 dark:text-blue-300 mb-2">What's included?</h4>
