        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg p-8 space-y-8">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">2. Use License</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">5. Seller Obligations</h2>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">6. Buyer Obligations</h2>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">8. Termination</h2>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
